...
#bg image
background = pygame.image.load("C:/Users/talga/OneDrive/Рабочий стол/PP2 Lab/Lab 8/img/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/talga/OneDrive/Рабочий стол/PP2 Lab/Lab 8/img/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/talga/OneDrive/Рабочий стол/PP2 Lab/Lab 8/img/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy):
        super().__init__()
        self.image = pygame.image.load("C:/Users/talga/OneDrive/Рабочий стол/PP2 Lab/Lab 8/img/coin.png")
        self.rect = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("C:/Users/talga/OneDrive/Рабочий стол/PP2 Lab/Lab 8/music/crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound("C:/Users/talga/OneDrive/Рабочий стол/PP2 Lab/Lab 8/music/getcoin.mp3").play()
        coin_score += 1
        coin = Coin(E1)
        coins_group.add(coin)
