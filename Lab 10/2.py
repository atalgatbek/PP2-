...
# ==== Main Game Loop ====
# Add this at the beginning of game_loop function
def game_loop(username):
    ...
    while True:
        ...
        while snake.alive:
            ...
            if paused:
                draw_text(screen, "Paused", SCREEN_WIDTH // 2 - 60, SCREEN_HEIGHT // 2, 50, WHITE)
                pygame.display.update()
                clock.tick(5)
                continue
            ...
            draw_text(screen, f"Press 'P' to Pause", SCREEN_WIDTH - 200, 10, 30, WHITE)
